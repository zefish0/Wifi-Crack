...
<head>
    ...
    <title>Interface de configuration SFR</title>
...
<body>
    <div id="top-bar">
        ...
        <h1 id="title-livebox">SFR Box</h1>
    </div>
    <h3 id="subtitle-livebox">Bienvenue sur l'interface de configuration de votre Box SFR.</h1>
    
    <div id="form">
        <div class="col-sm">
            <h2 class="firmware-lead-text">Mise à jour du micrologiciel</h2>
            <p class="firmware-sub-text">Une mise à jour du micrologiciel de votre Box SFR (version 2.3.1) a été détecté et est prête à être installée. Veuillez vérifier les points suivants avant de poursuivre.</p>
        </div>
